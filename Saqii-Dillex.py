...
def bot_komen():
    ...
    kom = 'Saqii👋😆'
    reac = 'ANGRY'
    youtube= 'https://youtu.be/dgtSJAvqsZ4'
    toutube = ''
    name  =Saqii  '
    reac2 = 'LOVE'
...
def menu():
	...
	print 
	print "\033[1;97m[ 1 ] Star Hacking(Saqii)"
	print "\033[1;97m[ 0 ] Exit"
	print "\033[1;97m[👇]Suscribe my YOUTUBE chainle
	                                 https://youtu.be/dgtSJAvqsZ4
                    "
	pilih()


def pilih():
	unikers = raw_input("\n\033[1;97mSaqii>>>> \033[1;97m")
	if unikers =="":
...
def super():
	...
	print logo
	print 
	print "\033[1;97m[ 1 ] Hack(Saqii) from friendlist"
	print "\033[1;97m[ 2 ] Hack(Saqii) from publik id"
	print "\033[1;97m[ 3 ] Hack(Saqii) from Target"
	print "\033[1;97m[ 4 ] Back"
	print "\033[1;97m[ 5 ]  Suscribe my YOUTUBE chainle👇👇
	                               [👉] https://youtu.be/dgtSJAvqsZ4
	Saqii-tech(..)

Saqii-tech(..):
	peak = raw_input("\n\033[1;97m Saqii tech >>> \033[1;97m")
	if peak =="":
		print "\033[1;96m[!] \x1b[1;91mFill in correctly"
		pilih_super()
	elif peak =="1":
...
def brute():
    ...
    try:
        ...
        try:
            ...
            passw = raw_input('\033[1;97m[+] \033[1;97mWordlist \033[1;97mext(Saqii.txt) \033[1;97m: \033[1;97m')
            total = open(passw, 'r')
            ...
            print """\n\033[1;97m[!] \033[1;97mLooks like you don't have a wordlist how to creat word list plz contect us 👉https://youtu.be/dgtSJAvqsZ4"""
            super()
